...
println(startsWith(Stream(1,2,3),Stream(1,2,3))) // -> true
println(startsWith(Stream(1,2,3),Stream(1,2))) // -> true
println(startsWith(Stream(1,2,3),Stream(2,2))) // -> false
println(startsWith(Stream(1,2),Stream(1,2,3))) // -> false